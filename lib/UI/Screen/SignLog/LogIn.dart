          ...
          children: [
            ...
            Padding(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    FreeWidget().textFormField(controller: _nameCon,hintText: 'الأسم '),
                    FreeWidget().textFormField(controller: _taxNumberCon,hintText: 'رقم السجل الضريبي'),
                    ...
                    // FreeWidget().textFormField(controller: _mobileNumberCon,hintText: "رقم الهاتف "),
                    FreeWidget().textFormField(
